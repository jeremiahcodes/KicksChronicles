...
function BrandDataCard(props: Props) {
  return (
        ...
        <div className="col-sm-6 col-md-4">
          <div className="card card-hover border-0 rounded-1 overflow-hidden"><img src={props.brandItem.logoURL} alt="Image"/>
            <div className="position-absolute top-0 start-0 w-100 h-100 opacity-0">
              ...
              <div className="card-body d-flex flex-column justify-content-end dark-mode h-100 position-relative zindex-2 text-center">
                <h3 className="h5 mb-1">{props.brandItem.name}</h3>
                <p className="mb-3">{props.brandItem.description}</p>
